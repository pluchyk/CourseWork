...
/**
 * Servlet implementation class StudentLoginCtl
 */
@WebServlet(name = "StudentLoginCtl", urlPatterns = {"/home/login/student"})
public class StudentLoginCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (id > 0) {
			...
			ServletUtility.forward(ELearnView.STUDENT_LOGIN_VIEW, request, response);
			return;
		}
...
HttpSession session = request.getSession(true);
	...
	protected String getView() {
		...
		return ELearnView.STUDENT_LOGIN_VIEW;
	}
