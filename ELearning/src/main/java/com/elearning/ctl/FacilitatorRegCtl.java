...
/**
 * Servlet implementation class FacilitatorRegCtl
 */
@WebServlet(name = "FacilitatorRegCtl",urlPatterns = {"/home/signup/facilitator"})
public class FacilitatorRegCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (action) {
		case "/home/signup/facilitator":
			ServletUtility.forward(getView(), request, response);
			break;
		case "/home/signup/student":
			ServletUtility.forward("/jsp/StudentRegView.jsp", request, response);
			break;	
		case "/home/signup/faculty":
			ServletUtility.forward("/jsp/FacultyRegView.jsp", request, response);
			break;	
		default:
			break;
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_SIGN_UP.equalsIgnoreCase(op)) {
			...
			try {
				...
				ServletUtility.setSuccessMessage("Facilitator Successfully Registered", request);
				ServletUtility.forward(ELearnView.FACILITATOR_REG_VIEW, request, response);
				return;
	...
	protected String getView() {
		// TODO Auto-generated method stub
		return ELearnView.FACILITATOR_REG_VIEW;
	}
