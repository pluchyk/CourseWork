...
/**
 * Servlet implementation class FacultyRegCtl
 */
@WebServlet(name = "FacultyRegCtl" , urlPatterns = {"/home/signup/faculty"})
public class FacultyRegCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_SIGN_UP.equalsIgnoreCase(op)) {
			...
			try {
				...
				ServletUtility.forward(ELearnView.Faculty_REG_VIEW, request, response);
				return;
			...
			ServletUtility.redirect(ELearnView.Faculty_REG_VIEW, request, response);
			return;
		}
	}
	...
	protected String getView() {
		...
		return ELearnView.Faculty_REG_VIEW;
	}
