<%@page import="com.elearning.ctl.StudentRegCtl"%>
	...
	<div class="container">
		<div class="card mt-5 mx-auto text-center" style="width: 18rem;">
			...
			<div class="card-body">
				...
				<form action="<%=ELearnView.STUDENT_REG_CTL%>" method="post">
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%></font></b>
				<div  class="form-group"> <input
					...
					<div  class="form-group"> <input
							...
							aria-describedby="emailHelp" name="login" value="<%=DataUtility.getStringData(bean.getLogin())%>" placeholder="Email/Username">
					<font  color="red"><%=ServletUtility.getErrorMessage("login", request)%></font>
					</div>
					<div class="form-group">
						 <input
							type="password" name="password" class="form-control" value="<%=DataUtility.getStringData(bean.getPassword())%>" id="exampleInputPassword1"
					...
					<button type="submit" name="operation" class="btn btn-primary" value="<%=StudentRegCtl.OP_SIGN_UP%>">Submit</button>
				</form>
